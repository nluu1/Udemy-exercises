...
## Section 4:
>:page_facing_up:: section4.ipynb
- Matrices
- Building matrices: np.reshape,np.array
- Dictionaries
- Matrix operations
- Visualization with Pyplot
- Creating functions/ advanced function design
- Deriving insights
- >:blue_book:: Basketball free throw

## Section 5:
>:page_facing_up:: section5.ipynb
- *in process*
